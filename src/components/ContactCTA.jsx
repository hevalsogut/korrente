 ...
 */
export default function ContactCTA({ eyebrow, title, body }) {
  const { t } = useI18n()
        ...
        <Reveal className="contact-cta__panel">
          ...
          <div className="contact-cta__content">
            ...
            <div className="contact-cta__actions">
              <Button to="/contact" size="lg" icon="arrowUpRight">
                {t('common.startProject')}
              </Button>
              <Button href={`mailto:${company.email}`} variant="outline" size="lg" icon="mail">
                {company.email}
              </Button>
            </div>
          </div>
